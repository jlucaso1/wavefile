...
describe('Downsample a 32-bit 44.1kHz log sine sweep', function() {
  ...
  wav.toSampleRate(16000, {method: 'linear', LPF: true, LPFType: 'FIR'});

  // Write the file
  fs.writeFileSync(
    path + "/out/to-sample-rate/linear-32fp-16000Hz-mono-chirp-1-22050-log.wav",
    wav.toBuffer());
});
...
describe('Upsample a 32-bit 44.1kHz log sine sweep', function() {
  ...
  // Convert to another sample rate
  wav.toSampleRate(96000, {method: 'linear', LPF: true, LPFType: 'FIR'});

  // Write the file
  fs.writeFileSync(
    path + "/out/to-sample-rate/linear-32fp-96000Hz-mono-chirp-1-22050-log.wav",
    wav.toBuffer());
});
...
describe('Downsample a 32-bit 44.1kHz linear sine sweep', function() {
  ...
  // Write the file
  fs.writeFileSync(
    path + "/out/to-sample-rate/linear-32fp-16000Hz-mono-chirp-1-22050-linear.wav",
    wav.toBuffer());
});
...
describe('Upsample a 32-bit 44.1kHz linear sine sweep', function() {
  ...
  // Write the file
  fs.writeFileSync(
    path + "/out/to-sample-rate/linear-32fp-96000Hz-mono-chirp-1-22050-linear.wav",
    wav.toBuffer());
});
...
describe('Downsample a 16-bit 44.1kHz log sine sweep', function() {
  ...
  // Write the file
  fs.writeFileSync(
    path + "/out/to-sample-rate/linear-16bit-16000Hz-mono-chirp-1-22050-log.wav",
    wav.toBuffer());
});
...
describe('Upsample a 16-bit 44.1kHz log sine sweep', function() {
  ...
  // Write the file
  fs.writeFileSync(
    path + "/out/to-sample-rate/linear-16bit-96000Hz-mono-chirp-1-22050-log.wav",
    wav.toBuffer());
});
...
describe('Downsample a 16-bit 44.1kHz linear sine sweep', function() {
  ...
  // Write the file
  fs.writeFileSync(
    path + "/out/to-sample-rate/linear-16bit-16000Hz-mono-chirp-1-22050-linear.wav",
    wav.toBuffer());
});
...
describe('Upsample a 16-bit 44.1kHz linear sine sweep', function() {
  ...
  // Write the file
  fs.writeFileSync(
    path + "/out/to-sample-rate/linear-16bit-96000Hz-mono-chirp-1-22050-linear.wav",
    wav.toBuffer());
});
...
describe('Downsample a 16bit 44.1kHz file', function() {
  ...
  // Write the file
  fs.writeFileSync(
    path + "/out/to-sample-rate/linear-song1-16kHz.wav",
    wav.toBuffer());
});
