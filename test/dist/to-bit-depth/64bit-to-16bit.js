 ...
 *
 * Test the toBitDepth() method to convert an 64-bit file to 16-bit.
 * 
 */
...
describe("64-bit from file to 16-bit", function() {

    let wav = new WaveFile(
        fs.readFileSync(path + "64bit-48kHz-noBext-mono.wav"));
    wav.toBitDepth("16");
    fs.writeFileSync(
        path + "/out/to-bit-depth/64-to-16.wav", wav.toBuffer());
...
describe("64-bit mono from scratch to 16-bit (max range)", function() {
...
describe("64-bit mono from scratch to 16-bit (0)", function() {
