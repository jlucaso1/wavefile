 ...
 *
 * Test writing 15-bit files with the fromScratch() method.
 * 
 */
...
describe('create 15-bit wave files from scratch', function() {
    ...
    fs.writeFileSync(
        "././test/files/out/15-bit-48kHz-mono-fromScratch.wav",
        wav.toBuffer());
    ...
    it('bitDepth should be "15"', function() {
        assert.equal(wav.bitDepth, "15");
    });
